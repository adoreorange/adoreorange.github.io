const FcircleModule = (() => {
    const config = {
        ...
        // API_URL: 'http://60.205.14.58:8521/feed',
        ...
        ERROR_IMGS: [
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479467f79.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a2647945b0e3.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479449e65.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a2647944ec58.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479345bde.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a264792cd7b2.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a2647929eba0.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479285091.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479273eee.jpg",
            "https://lsky.adoreorg.cn/i/2026/06/08/6a26479275b39.jpg",
        ]
    }
    ...
    // 全局错误图片处理函数（供HTML onerror事件使用）
    window.handleAvatarError = function(img) {
        const { ERROR_IMGS } = config;
        if (!Array.isArray(ERROR_IMGS) || ERROR_IMGS.length === 0) {
            img.src = 'data:image/svg+xml;base64,';
        } else {
            img.src = ERROR_IMGS[Math.floor(Math.random() * ERROR_IMGS.length)];
        }
                ...
                card.innerHTML = `
                    <div class="card-header">
                        ...
                        <div class="card-author">
                            <img src="${avatar}" alt="${authorName}" class="avatar" loading="lazy" decoding="async" onerror="window.handleAvatarError(this);">
                            <div>
