...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | adoreorg🍊")[0];
}
...
function initHolidayPopup() {
  ...
  if (typeof Swal === 'undefined') {
    setTimeout(initHolidayPopup, 100);
    return;
  }
...
class BackgroundManager {
  constructor() {
    ...
    this.imageSuffixes = [
      ...
      "37.webp", "38.webp", "39.webp", "40.webp", "51.webp","52.webp", "53.webp", 
      "54.webp","55.webp", "56.webp", "57.webp", "58.webp", "59.webp", 
      "60.webp","61.webp", "62.webp"
    ];
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  if (isPageReload) {
    ...
    document.getElementById("defineBg").innerText = `:root{
      ...
      --mobileday-bg: url(https://source.adoreorg.cn/webp/phwebp/24.webp);
      --mobilenight-bg: url(https://source.adoreorg.cn/webp/phwebp/23.webp);
    }`;
  } else {
    // 正常页面访问，使用之前保存的背景
...
<h2>二、字体设置</h2>
    ...
    <div class="note note-warning">
      <div class="note-header">
        ...
        <span class="note-title">modern</span>
      </div>
      <div class="note-content">
        <p>非商免字体未经授权只能个人使用。本站为完全非商业、非盈利性质的网站，平时用于个人学习交流，如有侵权请联系站长删除，谢谢！ —— 致版权方</p>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/17.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/adoreorange/pic_bed@main/webp/phwebp/17.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/18.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/18.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/19.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/19.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/20.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/20.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/21.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/21.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/22.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/22.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/25.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/25.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/26.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/26.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.adoreorg.cn/webp/phwebp/27.webp)" class="pimgbox" onclick="changeBg('url(https://source.adoreorg.cn/webp/phwebp/27.webp)')"></a>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://source.adoreorg.cn/webp/select/14.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
