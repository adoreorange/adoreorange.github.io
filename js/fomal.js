...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.jsdelivr.net/gh/adoreorange/pic_bed@main/webp/ACGN/16.webp);
    --darkmode-bg:url(https://cdn.jsdelivr.net/gh/adoreorange/pic_bed@main/webp/select/1.webp);
    --mobileday-bg: url(https://cdn.jsdelivr.net/gh/adoreorange/pic_bed@main/webp/phwebp/5.jpg);
    --mobilenight-bg: url(https://cdn.jsdelivr.net/gh/adoreorange/pic_bed@main/webp/phwebp/6.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
