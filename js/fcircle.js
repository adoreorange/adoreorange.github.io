const FcircleModule = (() => {
    ...
    const getRandomErrorImg = () => {
        const errorImgs = config.ERROR_IMGS;
        const randomIndex = Math.floor(Math.random() * errorImgs.length);
        return errorImgs[randomIndex];
    }
                ...
                card.innerHTML = `
                    <div class="card-header">
                        ...
                        <div class="card-author">
                            <img src="${avatar}" alt="${authorName}" class="avatar" loading="lazy" onerror="this.onerror=null;this.src='${getRandomErrorImg()}';">
                            <div>
